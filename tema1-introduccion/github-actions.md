...
- [{{ page.title }}](#-pagetitle-)
  - [Workflow](#workflow)
  - [Editing Github Actions](#editing-github-actions)
  - [Job](#job)
  - [Step](#step)
  - [Actions](#actions)
    - [Types of Actions](#types-of-actions)
  - [Event](#event)
    - [The `release` event](#the-release-event)
  - [Runner](#runner)
  - [Syntax of the .yml File](#syntax-of-the-yml-file)
    - [Name:](#name)
    - [On:](#on)
    - [Jobs:](#jobs)
    - [Env:](#env)
    - [steps.with](#stepswith)
  - [Expression Syntax](#expression-syntax)
    - [literal values,](#literal-values)
    - [Operators](#operators)
    - [functions](#functions)
    - [The if Keyword and Functions to Check Job Status](#the-if-keyword-and-functions-to-check-job-status)
  ...
  - [Contexts](#contexts)
    ...
    - [The Runner Context](#the-runner-context)
    - [The Strategy Context](#the-strategy-context)
    - [The Secrets Context](#the-secrets-context)
      - [Creating a Secret](#creating-a-secret)
      - [Using a Secret](#using-a-secret)
      - [Example: A GitHub Action to Publish a npm Package](#example-a-github-action-to-publish-a-npm-package)
    - [Exercise](#exercise)
    - [Debugging Context to the log file](#debugging-context-to-the-log-file)
      - [Exercise](#exercise-1)
  - [GITHUB_TOKEN](#github_token)
  - [Creating a Packaged JavaScript Action](#creating-a-packaged-javascript-action)
  - [Running Manually GitHub Workflows with gh](#running-manually-github-workflows-with-gh)
  - [References](#references)
  - [Videos about GitHub Actions](#videos-about-github-actions)
